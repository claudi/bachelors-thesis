...
%In the other direction, there is a functor $F: \cat{C} \to \cat{C}_T$ which sends
%$A\in \cat{C}$ to $A\in \cat{C}_T$ (identity on objects), and which sends
%$f:A \to B$ to the composite
%$$
%\begin{tikzcd}
%A \ar[r, "f"] & B \ar[r, "\eta_B"] & TB
%\end{tikzcd}
%$$
%(Again one checks this is a functor.)
