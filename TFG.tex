...
\begin{example}[Non-determinism]
    Suppose we have a procedure~\(A\longrightarrow B\) that is
    non-deterministic and has no side-effects. To model its behaviour through a
    mathematical function we could consider the function
    \[
