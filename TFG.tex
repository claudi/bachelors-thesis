...
name, without parenthesis and separated by spaces. For example, if we had
a~\mintinline{Haskell}{factorial :: Int -> Int} function and we wanted to
evaluate it at~\mintinline{Haskell}{5 :: Int} we would write
\begin{minted}{Haskell}
factorial 5
\end{minted}
